  ...
  return (
    <main className="bg-stone-50 min-h-screen">
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="mb-10">
          <p className="text-xs uppercase tracking-[0.25em] text-teal-600 font-medium">Panel de admin</p>
          <h1 className="mt-2 text-3xl font-bold text-stone-900">
            Gestión de disponibilidad
          </h1>
          <p className="mt-2 text-sm text-stone-500">
            Hacé click en los días para marcarlos como disponibles. Los días en verde son visibles para los visitantes.
          </p>
        </div>
